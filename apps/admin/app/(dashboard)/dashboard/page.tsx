          ...
          <div>
            {ACTIVITY.map((item, i) => (
              <div
                ...
                style={{ ...activityRow, borderTop: i > 0 ? "1px solid #f0eeeb" : "none" }}
              >
          ...
          <div style={quickGrid}>
            {QUICK_LINKS.map(({ label, desc, color, href }) => (
              <a
                ...
                style={{ ...quickLink, borderLeft: `3px solid ${color}` }}
              >
...
const ACTIVITY = [
  ...
  {
    text: "Job posting approved — Senior Engineer at Stripe",
    time: "41 min ago",
    color: "#0ea5e9",
  },
